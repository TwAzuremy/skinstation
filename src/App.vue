...
.app {
    ...
    &__sidebar {
        ...
        &[data-animation="computer"] {
            @include flexible-animation($sidebar-width-ipad,
                $sidebar-width-computer,
                width,
                computer,
                true);
        }
        ...
        &[data-animation="computerToIpad"] {
            @include flexible-animation($sidebar-width-computer,
                $sidebar-width-ipad,
                width,
                computerToIpad,
                true,
        ...
        &[data-animation="phone"] {
            ...
            @include flexible-animation($sidebar-transform-phone + $sidebar-width-ipad,
                $sidebar-transform-phone,
                left,
                phone,
                false,
                true);
